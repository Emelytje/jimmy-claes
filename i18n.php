...
function i18n_dictionary(){
    return [
        ...
        'bdl_explain'       => ['nl' => 'Plak hieronder één dier per regel, in de vorm "Naam, Link" (of met een tab ertussen — zo plak je rechtstreeks twee kolommen uit een spreadsheet). De naam wordt exact vergeleken met de dier-titel. Titels die bewust dubbel in de boom voorkomen worden overgeslagen — die koppel je apart via de Drive-link-kolom in de Dieren-lijst.', 'en' => 'Paste one animal per line below, as "Name, Link" (or with a tab in between — so you can paste two spreadsheet columns directly). The name is matched exactly against the animal title. Titles that intentionally appear twice in the tree are skipped — link those separately via the Drive-link column in the Dieren list.'],
        'bdl_textarea_label' => ['nl' => 'Naam, Link (één per regel)', 'en' => 'Name, Link (one per line)'],
