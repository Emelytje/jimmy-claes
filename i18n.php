...
function i18n_dictionary(){
    return [
        ...
        'page_bg_color_label' => ['nl' => 'Vaste achtergrondkleur', 'en' => 'Fixed background color'],
        'page_bg_color_hint' => ['nl' => 'Geldt voor de hele pagina, achter alle blokken. Leeg = standaard (geen vaste kleur).', 'en' => 'Applies to the whole page, behind all blocks. Empty = default (no fixed color).'],
        'clear_label'       => ['nl' => 'wis', 'en' => 'clear'],
