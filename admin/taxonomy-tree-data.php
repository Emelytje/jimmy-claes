<?php
// Gedeelde taxonomieboom (Amfibieën/Reptielen/Vissen/Vogels/Zoogdieren), gebruikt door
// zowel seed-taxonomy.php (importeren) als fix-taxonomy-tree.php (structuur herstellen).
// name => [] (leaf category, optioneel met soorten als platte lijst)
//      or name => [subcategory tree...] (associatief = meer categorieën)
return [
        'Amfibieën' => [
            'Kikkers' => [
